...
''''''''''''''''''''''''''''''''''''''''/
' GLOBAL VARIABLES
gNbTileset    = 0   ' Nb tileset of star background
gPosScroll    = 0   ' Pos scrolling of star background
gDrawFunction = 0   ' Selected draw function
gDrawFunc     = 0   ' Pointer to the current drawing function
...
sub InitializeDrawing()
   shared gNbTileset, gPosScroll, gDrawFunc
   gNbTileset = 15
   gPosScroll = 0
   gDrawFunc  = 1
end sub
