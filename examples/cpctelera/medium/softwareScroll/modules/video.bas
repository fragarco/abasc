...
' for double buffering. Two screens are managed at &8000 and &C000. Users
...
'
function videoGetBackBufferPtr
   shared video.buffer
   videoGetBackBufferPtr = video.buffer
end function
...
'
sub videoSwitchBuffers
   shared video.buffer, HW.BACKBUFFER
   shared CPCT.VMEMSTART, VMP.PAGE80, VMP.PAGEC0
...
'
sub videoInitBuffers
   shared HW.BACKBUFFER
   ...
   call cpctMemset(HW.BACKBUFFER, 0, &4000)  ' 16K HW_BACKBUFFER set to 0
