...
_KEYWORDS = {
    ...
    "LOCATE","MASK","MEMORY","MERGE","MID$","MODE","MOVE","MOVER","NEW","NEXT",
    "ON","ON BREAK","ON ERROR GOTO", "ON SQ","OPENIN","OPENOUT","ORIGIN","OUT",
    "PAPER","PEN","PLOT","PLOTR","POKE","PRINT","RAD","RANDOMIZE","READ","RELEASE",
