...
_KEYWORDS = {
    # Commands
    "ATTRIBUTE","AFTER","ASM", "AUTO","BORDER","CALL","CASE","CASE DEFAULT","CAT",
    "CHAIN","CHAIN MERGE","CLEAR","CLEAR INPUT","CLG","CLOSEIN","CLOSEOUT","CLS","CONST",
    "CONT","COPYCHR$","CURSOR","DATA","DECLARE","DEF","DEF FN","DEF ATTRIBUTE",
    "DEFAULT", "DEFINT","DEFREAL","DEFSTR","DEG","DELETE","DERR","DI","DIM","DRAW",
    "DRAWR","EDIT","EI","ELSE","END","END IF","END SUB","END FUNCTION","END SELECT",
    ...
    "LIST","LOAD","LOCATE","MASK","MEMORY","MERGE","MID$","MODE","MOVE","MOVER","NEW","NEXT",
    "ON","ON BREAK","ON ERROR GOTO","ON SQ","OPENIN","OPENOUT","ORIGIN","OUT","PAPER",
    "PEN","PLOT","PLOTR","POKE","PRINT","RAD","RANDOMIZE","READ","READIN","RECORD",
    "RELEASE","REM","RENUM","RESTORE","RESUME","RETURN","RUN","SAVE","SELECT",
    "SELECT CASE","SOUND","SPC","SPEED","SPEED KEY","SPEED INK","SPEED WRITE","STEP",
    "STOP","SHARED","SUB","SWAP","SYMBOL","SYMBOL AFTER","TAB","TAG","TAGOFF","TO",
    "TROFF","TRON","THEN","USING","WAIT","WEND","WHILE","WIDTH","WINDOW","WINDOW SWAP",
    "WRITE","ZONE",
    # Functions
