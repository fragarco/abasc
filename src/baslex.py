...
_KEYWORDS = {
    ...
    "DEF","DEF FN","DEFINT","DEFREAL","DEFSTR","DEG","DELETE","DERR","DI","DIM","DRAW",
    ...
    "OUT","PAPER","PEN","PLOT","PLOTR","POKE","PRINT","RAD","RANDOMIZE","READ",
    "RELEASE","REM","RENUM","RESTORE","RESUME","RETURN","RUN","SAVE","SOUND","SPC",
    "SPEED","SPEED KEY", "SPEED INK", "SPEED WRITE","STEP","STOP","SWAP","SYMBOL",
