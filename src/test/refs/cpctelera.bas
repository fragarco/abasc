...
label TILEMAP.TILES
ASM "read 'assets/cpctelera_tiles.asm'"  ' Tile declarations (file generated after processing img/tiles.png)

label COURTMAP.MAP
ASM "read 'assets/cpctelera_court.asm'"  ' Court map declarations (file generated after processing img/court.tmx)
