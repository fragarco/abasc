...
RT_STR = {
    ...
    "rt_strz2int": [
        ...
        "; Inputs:\n",
        ";     HL address to the two-bytes integer\n",
        ...
        "\tsub     &30  ; '0' character\n",
        "\tcp      10\n",
        "\tjr      nc,__strz2int_end   ; some other character > 9\n",
        "\tinc     de\n",
        "\tld      b,h\n",
        "\tld      c,l\n",
        "\tadd     hl,hl  ; x2\n",
    ...
    "rt_strz2hex": [
        "; RT_STRZ2HEX\n",
        "; DE address to the null-terminated string with an hexadecimal number,\n",
        "; ends pointing to first\n",
        "; char not converted.\n",
        "; Inputs:\n",
        ";     DE address to the source null-terminated string\n",
        "; Outputs:\n",
...
RT_STDIO = {
    ...
    "rt_input": [
        ...
        ";      C total number of quote characters found\n",
        ";     AF, HL and BC are modified\n", 
        "rt_substring_buf:  defs  255     ; temporal memory to store substrings\n",
        "rt_extract_substring:\n",
        "\tld      de,rt_substring_buf\n",
        "\tld      c,0\n",
        "\tcall    __string_lstrip\n",
        "\tcp      &22     ; quote?\n",
