...
RT_STR = {
    ...
    "rt_strcmp": [
        "; Compares strings pointed by HL and DE and sets Z and C:\n",
        "; HL=DE Z=1, HL<DE Z=0 C=0, HL>DE Z=0 C=1\n",
        ";Inputs:\n",
        ";     HL and DE\n",
        ";Outputs:\n",
        ";     flags Z and C store the result of the comparation\n",
    ...
    "rt_strstrip": [
        ...
        ";     AF, B and DE are modified, C is preservedmake\n",
        "rt_strstrip:\n",
        "\tld      a,(de)     ; max characters to copy\n",
        "\tld      a,b\n",
        "\txor     a\n",
        "\tld      (hl),a     ; initial length is 0\n",
        "\tor      b\n",
        "\tret     z          ; empty string\n",
        "\tld      c,a        ; current source length\n",
        "__strstrip_leading:\n",
        "\tinc     de\n",
        "\tld      a,(de)\n",
        "\tcp      &20        ; white space\n",
        "\tjr      nz,__strstrip_trailing\n",
        "\tdjnz    __strstrip_leading\n",
        "\tret                ; all characters were spaces\n",
        "__strstrip_trailing:\n",
        "\tpush    de         ; first character to copy\n",
        "\tld      a,c\n",
        "\tsub     b          ; remaining characters\n"
        "\tld      b,a\n"
        "\tadd     a,e\n",
        "\tld      e,a\n",
        "\tadc     a,d\n",
        "\tsub     e\n",
        "\tld      d,a        ; DE points to the its string last char\n",
        "__strstrip_trailing_loop:\n",
        "\tld      a,(de)\n",
        "\tcp      &20        : white space\n",
        "\tjr      nz,__strstrip_copy\n",
        "\tdec     de\n",
        "\tdjnz    __strstrip_trailing_loop\n",
        "__strstrip_copy:\n",
        "\tpop     de\n",
        "\tld      (hl),b     ; resulting number of chars\n",
        "__strstrip_copy_loop:\n",
        "\tinc     hl\n",
        "\tld      a,(de)\n",
        "\tld      (hl),a\n",
        "\tinc     de\n",
        "\tdjnz    __strstrip_copy_loop\n",
        "\tret\n\n",
    ],
    "rt_int2str": [
...
RT_STDIO = {
    ...
    "rt_input": [
        ...
        ";     -\n",
        ";Outputs:\n",
        ";     HL points to the string in memory (__input_buf)\n",
        ";     C  stores the total number of printed chars\n",
        ";     AF, HL and BC are modified, DE is preserved\n",
        ...
        "\tjr      __input_enterchar\n",
        "__input_end:\n",
        "\tld      hl,__input_buf         ; string length \n",
        "\tld      (hl),c\n",
        "\tcall    rt_print_nl\n",
