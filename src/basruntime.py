...
RT_STR = {
    ...
    "rt_strcat": [
        "; HL, DE strings to cat\n",
        "; DE string will be append to HL\n",
        "; First byte contains the string length\n",
        ";Inputs:\n",
        ";     HL and DE\n",
        ";Outputs:\n",
        ...
        "\tld      b,(hl)\n",
        "\tsub     b\n",
        "\tld      b,a               ; BC number of bytes to copy\n",
        "\tpush    hl\n",
        "\tld      a,(hl)            ; destination string current len\n",
        "\tinc     hl\n",
        "\tadd     a,l\n",
        "\tld      l,a\n",
        "\tadc     a,h\n",
        "\tsub     l\n",
        "\tld      h,a               ; HL points to the next byte after its end\n",
        "\tinc     de\n",
        "\tldir\n",
        "\tpop     hl\n",
        "\tpop     af\n",
